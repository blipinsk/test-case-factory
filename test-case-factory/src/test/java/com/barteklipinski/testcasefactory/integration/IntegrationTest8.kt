...
import com.barteklipinski.testcasefactory.and
import com.barteklipinski.testcasefactory.combinationsOf
import com.barteklipinski.testcasefactory.excluding
import com.barteklipinski.testcasefactory.expect
...
class IntegrationTest8 {
    ...
    @Test
    fun `library works correctly for eight types of inputs`() {
        // given
        ...
        val testCases = combinationsOf {
            anyOf(inputs1) and
                    ...
                    anyOf(input6) and
                    exactly(input7) and
                    anyOf(inputs8) excluding ('b') excluding ('c')
        } expect (expected)
